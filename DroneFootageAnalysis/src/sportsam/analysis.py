...
class Analyzer:
    ...
    def zeroth_image_moment(self, object_id: Int = 1) -> dict[Int, Int]:
        """Calculate the zeroth moment (area) of binary masks for each frame.

        Args:
            object_id: Object ID to calculate area for. Defaults to 1.
        ...
        """
        result = {}
        for frame_idx, objects in self.data.items():
    ...
    def first_image_moment(self, object_id: Int = 1) -> dict[Int, tuple[Int, Int]]:
    ...
    def second_image_moment(self, object_id: Int = 1) -> dict[Int, tuple[Int, Int, Int]]:
